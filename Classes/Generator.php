...
class Generator
{
    ...
    public function __construct($name = 'Invoice')
    {
        ...
        $this->logo_height = config('pdf_generator.logo_height');
        $this->date = Carbon::now();
        $this->business_details = Collection::make(config('pdf_generator.business_details'));
        $this->customer_details = Collection::make([]);
        $this->footnote = config('pdf_generator.footnote');
        $this->tax_rates = config('pdf_generator.tax_rates');
        $this->due_date = config('pdf_generator.due_date') != null ? Carbon::parse(config('pdf_generator.due_date')) : null;
        $this->with_pagination = config('pdf_generator.with_pagination');
        $this->duplicate_header = config('pdf_generator.duplicate_header');
    }
