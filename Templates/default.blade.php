...
<body>
    <header>
        ...
        <div style="margin-left:300pt;">
            ...
            @if ($data->due_date)
            <b>Due date: </b>{{ $data->due_date->formatLocalized('%A %d %B %Y') }}<br />
            @endif
            @if ($data->number)
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->taxPriceFormatted((object)$tax_rate) }}
                                {{ $data->formatCurrency()->symbol }}</td>
                        </tr>
                        @endforeach
                        <tr>
                            <td><b>TOTAL</b></td>
                            <td><b>{{ $data->totalPriceFormatted() }} {{ $data->formatCurrency()->symbol }}</b>
                            </td>
                        </tr>
                    </tbody>
                </table>
